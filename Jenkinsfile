		...
		stages{
			...
			stage('Checkout') {
				steps {
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: '*/develop']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir: 'Microservicio']], gitTool: 'Git_Centos', submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'DonaldArmando', url: 'https://github.com/DonaldArmando/Parqueadero-Ceiba.git']]])
				}
			}
